...
//----------------------------------------------------------------------
  ...
  #include <cvalues>					// replacement for limits.h
	...
	const float ANN_DBL_MAX = MAXFLOAT;	// insert maximum double
#else
//  #include <climits>
//  #include <cfloat>
	// const double ANN_DBL_MAX = DBL_MAX;
	const float ANN_DBL_MAX = 3.402* pow( 10.0 , 38.0 );
#endif

#define ANNversion 		"1.1.1"			// ANN version and information
#define ANNversionCmt	" modified for Android Platform by Jordan Frank"
