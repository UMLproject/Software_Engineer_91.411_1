...
public:
	...
	virtual void getStats(						// get tree statistics
				...
				ANNorthRect &bnd_box) = 0;		// bounding box
												// print node
	virtual void print(int level, FILE *out) = 0;
	virtual void dump(FILE *out) = 0;		// dump node
...
public:
	...
	virtual void print(int level, FILE *out);// print node
	virtual void dump(FILE *out);			// dump node
