...
public class PowerTop extends Activity implements Runnable {
  ...
  private void refreshView() {
    ...
    System.err.println("topWindowType:" + prefs.getInt("topWindowType", Counter.WINDOW_TOTAL));
    int s = noUidMask | prefs.getInt("topIgnoreMask", 0);
    System.err.println("noUidMask:" + noUidMask + "---topIgnoreMask:" + prefs.getInt("topIgnoreMask", 0) + "----IgnoreMask:" + s);
    try {
