...
import falldetection.analysis.fall.FallDetection;
...
//  public static final int ITERATION_INTERVAL = 1000; // 1 second
  public static final int ITERATION_INTERVAL = 10; // 1 second
...
//	  long time = System.currentTimeMillis();
    ...
    //为每一个耗电的程序，建一个线程。为每个耗电的程序单独记录耗电情况
...
//      System.out.println("iter:"+iter+":"+(System.currentTimeMillis() - time));
//      time = System.currentTimeMillis();
      ...
      for(int i = 0; i < components; i++) {
        ...
        for(int j = 0; j < uidPower.size(); j++) {
          ...
          //这个就是获取本程序的耗电，有时候一个循环中。没有uid=FallDetection.id耗电数据.导致为0.
          if(uid == FallDetection.uid){
//        	  System.out.println("iter :"+iter+"  "+uid+"add:"+power);
        	  total = total +power;
          }
      ...
      //后面的基本是一些日志记录。我或者是ui更新。更本程序没有关系。我把确定没有关系的代码注释了。
