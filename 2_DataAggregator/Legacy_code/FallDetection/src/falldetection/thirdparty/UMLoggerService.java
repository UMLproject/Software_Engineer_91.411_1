...
//android.os.Debug.startMethodTracing("pt.trace");
    try {
		...
		System.out.println("UML LoggerService :"+e.getMessage());
		Toast.makeText(getApplicationContext(), 
				"³ÌÐòÒòÎªUMLLoggerService:"+e.toString(), Toast.LENGTH_LONG).show();
	}
  }
...
//android.os.Debug.stopMethodTracing();
  ...
  public void showNotification(){
    ...
    // icon from resources
    CharSequence tickerText = "FallDetection";              // ticker-text
    long when = System.currentTimeMillis();         // notification time
    Context context = getApplicationContext();      // application Context
    CharSequence contentTitle = "FallDetection";  // expanded message title
